...
import com.badbadcode.application.repository.RoleRepository;
import com.badbadcode.application.service.UserService;
...
public class UserController {
	...
	public ResponseEntity<String> postEditUserChangePassword(@Valid @RequestBody ChangePasswordForm form, Errors error){
		try {
			if(error.hasErrors()) {
				String result = error.getAllErrors()
									 .stream()
